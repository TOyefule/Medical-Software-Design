...
- Terminology
  ...
  - "Encryption at Rest" ([AES](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard)) (HIPPA)
  - "Encryption in Transit" ([TLS/SSL](https://en.wikipedia.org/wiki/Transport_Layer_Security)) (HIPPA)
